...
- Three published resources are also linkable: write [Resume](/docs/resume.pdf) for the resume, [Athena product overview](https://athena.wigclub.store/landing) for the live product, and [Athena repository](https://github.com/kwam1na/athena) for its source repository. Use only those exact destinations. This list says where those links may point when one is warranted; it is not an invitation to offer them.
